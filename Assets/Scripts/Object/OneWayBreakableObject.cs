...
public class OneWayBreakableObj : HealthManager
{
    ...
    public bool damageableFromRight = true;
    ...
    public override void ApplyDamage(int amount)
    {
        ...
        bool playerFacingRight = PlayerMovement.instance.getFacingDirection();



        if (iFrameTimer <= 0 && playerFacingRight != damageableFromRight)
        {
